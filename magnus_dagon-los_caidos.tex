...
\newcommand{\parbreak}{\bigskip\centerline{$\ast\quad\ast\quad\ast$}\bigskip\noindent}
\newenvironment{prev}
    {\begin{quotation}\begin{em}\noindent\ignorespaces}
    {\end{em}\end{quotation}\vspace{-\baselineskip}\parbreak\vspace{-\baselineskip}}
\newenvironment{next}
    {\parbreak\vspace{-2\baselineskip}\begin{quotation}\begin{em}\noindent\ignorespaces}
